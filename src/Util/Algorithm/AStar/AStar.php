...
namespace MueR\AdventOfCode\Util\Algorithm\AStar;

use MueR\AdventOfCode\Util\Algorithm\AStar\Node\Collection\NodeCollectionInterface;
...
class AStar
{
    ...
    private NodeCollectionInterface|NodeHashTable $openList;
    /** @var NodeCollectionInterface<TState> | NodeHashTable<TState> */
    private NodeCollectionInterface|NodeHashTable $closedList;
